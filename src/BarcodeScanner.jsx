...
export default function BarcodeScanner({onDetected,onClose}){
 const videoRef=useRef(null),streamRef=useRef(null),timerRef=useRef(null),busyRef=useRef(false),detectedRef=useRef(false),onDetectedRef=useRef(onDetected),[error,setError]=useState(''),[ready,setReady]=useState(false);
